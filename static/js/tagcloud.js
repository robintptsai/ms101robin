...
if (!oDiv) return;
var $window = $(window);
var radius = 130; // the radius of the tag cloud, increase it if you have lots of tags
var dtr = Math.PI/180;
var d=300;
...
var distr = true;
var tspeed=10;
var size=260; // keep it about twice of radius
...
$(function ()
{
	...
	t = new Date() - t;
	if (t > 90) { // disable it for low speed computer
