...
BLOG_TITLE = u'Master Shares' # blog title
BLOG_SUB_TITLE = u'MasterStudio101 - Your Best Partner'# blog sub title
BLOG_DESCRIPTION = BLOG_SUB_TITLE # blog description for feed
BLOG_AUTHOR = 'Robin Tsai<robintptsai@gmail.com>' # blog author
...
SOCIAL_MEDIAS = [
	{'icon': 'about', 'url': 'https://en.gravatar.com/robintptsai', 'title': 'about robin', 'text': 'about', 'rel': 'nofollow'},
	{'icon': 'twitter', 'url': 'https://twitter.com/robintptsai', 'title': 'twit robin', 'text': '@robintptsai', 'rel': 'nofollow'},
	{'icon': 'google-plus', 'url': 'https://plus.google.com/u/0/104848088256702639103', 'title': '+ robin', 'text': '+robintptsai', 'rel': 'nofollow'},
...
LINKS = [
	{'url': 'http://www.google.com/a/', 'text': 'Google App', 'rel': 'nofollow'},
	{'url': 'http://code.google.com/appengine', 'text': 'Google App Engine', 'rel': 'nofollow'},
	{'url': 'http://www.heroku.com/', 'text': 'heroku', 'rel': 'nofollow'},
	{'url': 'http://aws.amazon.com', 'text': 'Amazon Web Service', 'rel': 'nofollow'},
	{'url': 'https://github.com/', 'text': 'github', 'rel': 'nofollow'},
	{'url': 'http://www.springsource.org/', 'text': 'Spring', 'rel': 'nofollow'},
] # links for sidebar

GOOGLE_ANALYTICS_ID = 'UA-31781809-1' # Google Analytics web property ID, leave it as empty if you don't use it
GOOGLE_CSE_ID = 'masterstudio101' # Google Custom Search ID, left it as empty if you don't use it. You can get it from http://www.google.com/cse/manage/create
...
ADMIN_EMAIL = 'robintptsai@gmail.com' # admin email address for sending and receiving email
